...
<html lang="es">
    <head>
        ...
        <title>Trabajo Social - UAnorte</title>
        <link rel="stylesheet" href="../assets/css/preloader.css">
        <link rel="stylesheet" href="../assets/css/header.css">
        <link rel="stylesheet" href="../assets/css/footer.css">
        <link rel="stylesheet" href="../assets/css/cta.css">
        <link rel="stylesheet" href="../assets/css/trabajoSocial.css">
    ...
    <!-- =================================================== INCLUDES =================================================== -->
        ...
        <main class="main">
            <section class="programa">
                ...
                <aside class="sidebar">
                    <img
                        src="../assets/img/trabajoSocial.jpg"
                        alt="Trabajo Social"
                        class="sidebar-image"
                    >
                    <div class="overlay">
                ...
                <main class="content">
                    ...
                    <section class="hero">
                        ...
                        <p>
                            Prepara profesionales comprometidos con el desarrollo humano y social, capaces de diseñar 
                            e implementar estrategias de intervención comunitaria.

                            <br>

                            Res. 015897 de Diciembre 18 de 2019, SNIES Nº 108960
                        </p>
                        <div class="buttons">
                    ...
                    <section>
                        ...
                        <ul class="list">
                            <li>Prácticas en comunidades reales</li>
                            <li>Enfoque humanista e integral</li>
                            <li>Intervención en comunidades y familias</li>
                        </ul>
                    </section>
                    ...
                    <section>
                        ...
                        <div class="perfil-grid">
                            <div class="perfil-item"><span>1</span> Intervención y gestión social</div>
                            <div class="perfil-item"><span>2</span> Liderazgo comunitario</div>
                            <div class="perfil-item"><span>3</span> Investigación aplicada</div>
                            <div class="perfil-item"><span>4</span> Formulación de proyectos</div>
                        </div>
                    </section>
